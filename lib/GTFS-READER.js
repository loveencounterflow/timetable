...
(function() {
  var $, ASYNC, P, REGISTRY, TEXT, TRM, TYPES, alert, badge, datasource_infos, debug, echo, global_data_limit, help, info, log, njs_fs, options, rainbow, registry, rpr, urge, warn, whisper, _ref, _ref1;
  ...
  this.$filter_routes = function(registry) {
    return $((function(_this) {
      return function(record, handler) {
        if (!/^U4/.test(record['route_short_name'])) {
          return handler(null);
        }
        return handler(null, record);
      };
