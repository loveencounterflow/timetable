...
(function() {
  ...
  this.register_2 = function(registry, record, handler) {
    ...
    var entries, facet_route, id, idn, idn_1, index_level, index_type, key, meta_value, name, realm, realm_1, route, tasks, type, type_1, value, _, _ref, _ref1, _ref2;
    id = record['id'];
    if (id == null) {
      throw new Error("unable to register record without ID:\n" + (rpr(record)));
    }
    ...
    for (name in record) {
      ...
      _ref1 = index_type.split('-'), index_level = _ref1[0], index_type = _ref1[1];
      switch (index_type) {
        case 'link':
          idn_1 = value;
          _ref2 = name.split('-'), realm_1 = _ref2[0], type_1 = _ref2[1], _ = _ref2[2];
        ...
        case 'facet':
          ...
          break;
        default:
          throw new Error("unknown index type " + (rpr(index_type)));
      }
    ...
    tasks = (function() {
      ...
      for (_i = 0, _len = entries.length; _i < _len; _i++) {
        _ref3 = entries[_i], key = _ref3[0], value = _ref3[1];
        _results.push({
          type: 'put',
          key: key,
          value: value
