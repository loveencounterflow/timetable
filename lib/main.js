...
(function() {
  var ASYNC, T, TEXT, TRM, TYPES, alert, as_transformer, badge, datasource_infos, debug, echo, help, info, log, new_parser, njs_fs, options, rainbow, rpr, urge, warn, whisper;
  ...
  this.read_agencies = function(route, registry, handler) {
    ...
    input = this._create_readstream(route);
  ...
  this._create_readstream = function(route) {
    var CombinedStream, R, routes, type, _i, _len, _ref;
