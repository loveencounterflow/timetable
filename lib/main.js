...
(function() {
  var ASYNC, T, TEXT, TRM, TYPES, alert, as_transformer, badge, create_readstream, datasource_infos, debug, echo, help, info, log, new_parser, njs_fs, options, rainbow, rpr, urge, warn, whisper;
