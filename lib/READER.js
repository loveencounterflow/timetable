...
(function() {
  ...
  this.read_route_nodes = function(registry, handler) {
    ...
    return input.pipe(this.$add_n4j_system_properties('route')).pipe(this.$add_id()).pipe(this.$remove_gtfs_fields()).pipe(this.$register(registry)).pipe(P.$collect_sample(input, 1, function(_, sample) {
  ...
  this.read_agency_nodes = function(registry, handler) {
    ...
    return input.pipe(this.$add_n4j_system_properties('agency')).pipe(this.$add_agency_id()).pipe(this.$remove_gtfs_fields()).pipe(this.$register(registry)).pipe(P.$collect_sample(input, 1, function(_, sample) {
  ...
  this.read_tour_nodes = function(registry, handler) {
    ...
    return input.pipe(this.$add_n4j_system_properties('tour')).pipe(this.$clean_trip_arr_dep()).pipe(this.$tour_from_trip(registry)).pipe(this.$add_tour_id()).pipe(this.$register(registry)).pipe(P.$collect_sample(input, 1, function(_, sample) {
