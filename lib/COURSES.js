...
(function() {
  var REGISTRY, TEXT, TRM, alert, badge, debug, echo, help, info, log, njs_crypto, rainbow, rpr, urge, warn, whisper,
  ...
  this.registered_course_from_reltrip_info = function(registry, reltrip_info) {
    var R, course_id, gtfs_stop_id, halt, station, station_id, _i, _len, _ref;
