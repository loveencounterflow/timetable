...
(function() {
  var ASYNC, T, TEXT, TRM, alert, as_transformer, badge, debug, echo, help, info, log, new_parser, njs_fs, options, rainbow, rpr, urge, warn, whisper;
  ...
  this.read_agencies = function(registry, handler) {
    var input, parser, route;
  ...
  this.read_stoptimes = function(registry, handler) {
    var input, parser, route;
    parser = new_parser(options['parser']);
  ...
  this.read_routes = function(registry, handler) {
    var input, parser, route;
    parser = new_parser(options['parser']);
  ...
  this.read_stations = function(registry, handler) {
    var input, parser, route;
    parser = new_parser(options['parser']);
  ...
  this.read_trips = function(registry, handler) {
    var input, parser, route;
    parser = new_parser(options['parser']);
