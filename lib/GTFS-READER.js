...
(function() {
  ...
  this.read_agency = function(registry, route, handler) {
    ...
    input.pipe(parser).pipe(T.$as_pods()).pipe(this.$clean_agency_record()).pipe(T.$delete_prefix('agency_')).pipe(T.$set('%gtfs-type', 'agency')).pipe(T.$rename('id', '%gtfs-id')).pipe(T.$dasherize_field_names()).pipe(this.$register(registry)).pipe(T.$count(input, 'agency')).pipe(T.$show_sample(input));
  ...
  this.read_stops = function(registry, route, handler) {
    ...
    input.pipe(parser).pipe(T.$skip(global_data_limit)).pipe(T.$as_pods()).pipe(this.$clean_stops_record()).pipe(T.$delete_prefix('stop_')).pipe(T.$set('%gtfs-type', 'stops')).pipe(T.$rename('id', '%gtfs-id')).pipe(this.$convert_latlon()).pipe(this.$register(registry)).pipe(T.$count(input, 'stops')).pipe(T.$show_sample(input));
  ...
  this.read_trips = function(registry, route, handler) {
    ...
    input.pipe(parser).pipe(T.$skip(global_data_limit)).pipe(T.$as_pods()).pipe(this.$clean_trip_record()).pipe(T.$delete_prefix('trip_')).pipe(T.$dasherize_field_names()).pipe(T.$set('%gtfs-type', 'trips')).pipe(T.$rename('id', '%gtfs-id')).pipe(T.$rename('route-id', '%gtfs-routes-id')).pipe(T.$rename('service-id', '%gtfs-service-id')).pipe(T.$count(input, 'trips')).pipe(this.$register(registry)).pipe(T.$show_sample(input));
  ...
  this.read_stop_times = function(registry, route, handler) {
    ...
    input.pipe(parser).pipe(T.$skip(global_data_limit)).pipe(T.$as_pods()).pipe(this.$clean_stoptime_record()).pipe(T.$set('%gtfs-type', 'stop_times')).pipe(T.$count(input, 'stop_times')).pipe(T.$show_sample(input));
